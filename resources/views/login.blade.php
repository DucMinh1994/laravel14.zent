...
<body>
	...
	<form action="?mod=login&act=postLogin" method="POST" enctype="multipart/form-data" class="form-login">
		<ul class="login-nav">
			<li class="login-nav__item active">
				<a href="?mod=login&act=form">Sign In</a>
			</li>
			<li class="login-nav__item">
				<a href="?mod=login&act=Signup">Sign Up</a>
			</li>
		</ul>
		...
		<input id="login-input-password" name="Mat_Khau" class="login__input" type="password" />
		<label for="login-sign-up" class="login__label--checkbox">
			<input id="login-sign-up" type="checkbox" class="login__input--checkbox" />
			Keep me Signed in
		</label>
		<button type="submit" class="login__submit" name="submit" >Sign in</button>
	</form>
